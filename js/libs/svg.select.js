...
SelectHandler.prototype.init = function (value, options) {
    ...
    var strWid = this.el.attr('stroke-width');
    // console.log(bbox);
    // console.log(this.el.attr('stroke-width'));
    // bbox.height +=2*strWid;
    // bbox.h +=2*strWid;
    // bbox.width += 2*strWid;
    // bbox.w += 2*strWid;
    ...
    this.nested.addClass('select-rect-svg');
...
SelectHandler.prototype.selectRect = function (value) {
    ...
    // this.rectSelection.set.addClass('qwer');
    ...
    if (!this.rectSelection.set.get(0)) {
        this.rectSelection.set.add(this.nested.rect(bbox.width, bbox.height)
