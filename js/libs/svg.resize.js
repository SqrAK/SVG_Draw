...
;(function () {
    ...
    (function () {
        ...
        ResizeHandler.prototype._extractPosition = function (event) {
            ...
            // Returns { x: .., y: .. }
            // console.log(`x ${event.clientX || event.touches[0].pageX}. y ${event.clientY || event.touches[0].pageY}`);
            return {
            ...
            switch (event.type) {
                ...
                case 'lt':
                    ...
                    this.calc = function (diffX, diffY) {
                        ...
                        var calcDiffY = diffY;
                        if(this.shift){
                            calcDiffY =  diffX*this.parameters.box.h/this.parameters.box.w;
                        }

                        var snap = this.snapToGrid(diffX, calcDiffY);
                ...
                case 'rt':
                    ...
                    this.calc = function (diffX, diffY) {
                        var calcDiffY = diffY;
                        if(this.shift){
                            // calcDiffY =  diffX*this.parameters.y/this.parameters.x;
                            calcDiffY =  -diffX*this.parameters.box.h/this.parameters.box.w;
                        }

                        // console.log(calcDiffY);
                        // console.log(diffY);
                        var snap = this.snapToGrid(diffX, calcDiffY, 1 << 1);
                        if (this.parameters.box.width + snap[0] > 0 && this.parameters.box.height - snap[1] > 0) {
                            if (this.parameters.type === "text") {
                                this.el.move(this.parameters.box.x - snap[0], this.parameters.box.y);
                                this.el.attr("font-size", this.parameters.fontSize + snap[0]);
                ...
                case 'rb':
                    ...
                    this.calc = function (diffX, diffY) {
                        ...
                        var snap = this.snapToGrid(diffX, calcDiffY, 0);
                        if (this.parameters.box.width + snap[0] > 0 && this.parameters.box.height + snap[1] > 0) {
                            if (this.parameters.type === "text") {
                                this.el.move(this.parameters.box.x - snap[0], this.parameters.box.y);
                                this.el.attr("font-size", this.parameters.fontSize + snap[0]);
                ...
                case 'lb':
                    ...
                    this.calc = function (diffX, diffY) {
                        ...
                        var snap = this.snapToGrid(diffX, calcDiffY, 1);
                        if (this.parameters.box.width - snap[0] > 0 && this.parameters.box.height + snap[1] > 0) {
                            if (this.parameters.type === "text") {
                                this.el.move(this.parameters.box.x + snap[0], this.parameters.box.y);
                                this.el.attr("font-size", this.parameters.fontSize - snap[0]);
                ...
                case 't':
                    ...
                    this.calc = function (diffX, diffY) {
                        var calcDiffX = diffX;
                        if(this.shift){
                            calcDiffX =  -diffY*this.parameters.box.w/this.parameters.box.h;
                        }
                        var snap = this.snapToGrid(calcDiffX, diffY, 1 << 1);
                        if (this.parameters.box.width + snap[0] > 0 && this.parameters.box.height - snap[1] > 0) {
                ...
                case 'b':
                    ...
                    this.calc = function (diffX, diffY) {
                        ...
                        var snap = this.snapToGrid(calcDiffX, diffY, 0);
                        if (this.parameters.box.width + snap[0] > 0 && this.parameters.box.height + snap[1] > 0) {
                            if (this.parameters.type === "text") {
                                return;
                            }
